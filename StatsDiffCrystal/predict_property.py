...
from common.data_utils import lengths_angles_to_volume, mard
from stats_diffcrystal.models import BaseModel
from stats_diffcrystal.encoders import DimeNetppEncoder
#from models.utils import gaussian_kld


class CrystGNN_Supervise(torch.nn.Module):
    """
    ...
    def __init__(self, cfg) -> None:
        ...
        self.model_name = "crystgnn"
        self.encoder = DimeNetppEncoder(**{k:v for k, v in self.hparams.encoder.items() if k!= '_target_'})
        # num_targets = 1
